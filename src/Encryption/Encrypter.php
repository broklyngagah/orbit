...
use Exception;
use Orbit\Machine\Encryption\DecryptException;
use Orbit\Machine\Encryption\EncryptInterface;
use Orbit\Machine\Support\SecureRandom;
use Orbit\Machine\Support\Str as StringUtils;

class Encrypter implements EncryptInterface
{
